...
```
  ...
  <h2 class="casefile-subtitle">Exhibit B: Basic Information</h2>
...
__Now we investigate how long victims survive after their diagnosis depending on number of nodes involved.__ Boxplots help visualize survival time differences clearly.
...
<div style="display: flex; justify-content: space-between; margin-top: 0px;">
  <!-- Left / Back -->
  <a href="evidence.html" class="casefile-button">
    ⬅️ Previous
  </a>

  <!-- Right / Next -->
  <a href="evidence_against.html" class="casefile-button">
    Next ➡️
  </a>
</div>